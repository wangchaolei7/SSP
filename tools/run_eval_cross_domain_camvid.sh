...
CHECKPOINT_NAME="${CHECKPOINT_NAME:-31-12_20-11}"
SAVE_DIR="${SAVE_DIR:-/data1/wangcl/project/SSP/camvid}"
CHECKPOINT_FOLDER="${CHECKPOINT_FOLDER:-video/}"
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/data1/wangcl/project/SSP/camvid/video/31-12_20-11/latest.pth.tar}"
SPLIT="${SPLIT:-val}"
