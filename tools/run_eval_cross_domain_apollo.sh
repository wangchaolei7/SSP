...
CHECKPOINT_NAME="${CHECKPOINT_NAME:-26-12_00-23}"
SAVE_DIR="${SAVE_DIR:-/data1/wangcl/project/SSP/apollo}"
CHECKPOINT_FOLDER="${CHECKPOINT_FOLDER:-video/}"
CHECKPOINT_PATH="${CHECKPOINT_PATH:-/data1/wangcl/project/SSP/apollo/video/26-12_00-23/latest.pth.tar}"
SPLIT="${SPLIT:-val}"
